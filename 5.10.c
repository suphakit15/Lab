...
int calcutate_change_amount(int cost, int paid);
int count_denomination(int *change_remaining, int demonomintion);
...
int main() {
    ...
    change_amount = calcutate_change_amount(total_cost, amount_paid);
